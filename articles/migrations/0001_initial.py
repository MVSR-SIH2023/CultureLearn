    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=255)),
                ('audio', models.FileField(upload_to='podcast_audios', validators=[django.core.validators.FileExtensionValidator(['mp3']), articles.models.validate_audio_file_extension])),
